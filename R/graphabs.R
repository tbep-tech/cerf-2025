...
png('figs/graphabs/graphabp1.png', height = hi, width = wd, family = 'serif', units = 'in', res = 300)
p1
dev.off()

png('figs/graphabs/graphabp2.png', height = hi, width = wd, family = 'serif', units = 'in', res = 300)
p2
dev.off()

png('figs/graphabs/graphabp3.png', height = hi, width = wd, family = 'serif', units = 'in', res = 300)
p3
dev.off()

png('figs/graphabs/graphabp4.png', height = hi, width = wd, family = 'serif', units = 'in', res = 300)
p4
dev.off()

png('figs/graphabs/graphabp5.png', height = hi, width = wd, family = 'serif', units = 'in', res = 300)
p5
dev.off()